...
public class MushroomDimensionChunkGenerator extends NoiseChunkGenerator<MushroomDimensionGenSettings>{
    ...
    public MushroomDimensionChunkGenerator(IWorld worldIn, BiomeProvider provider, MushroomDimensionGenSettings settingsIn) {
